...
class VerifyEmailView(View):
    ...
    def get(self, request, token):
        ...
        if success:
            ...
            messages.error(
                request, _("Ссылка подтверждения недействительна или устарела.")
            )
...
class PasswordResetConfirmView(View):
    ...
    def get(self, request, token):
        ...
        if not valid:
            messages.error(
                request, _("Ссылка сброса пароля недействительна или устарела.")
            )
            return redirect("users:login")
    ...
    def post(self, request, token):
        ...
        if form.is_valid():
            ...
            messages.success(
                request, _("Пароль успешно изменен! Теперь вы можете войти.")
            )
            return redirect("users:login")
