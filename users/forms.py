...
class UserRegistrationForm(UserCreationForm):
    ...
    first_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": _("Иван")}
        ),
    )
    last_name = forms.CharField(
        ...
        max_length=30,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": _("Иванов")}
        ),
    )
    ...
    def confirm_login_allowed(self, user):
        ...
        if not user.is_active:
            raise ValidationError(
                _(
                    "Этот аккаунт не активен. Подтвердите email или обратитесь к администратору."
                ),
                code="inactive",
            )
...
class CustomSetPasswordForm(SetPasswordForm):
    ...
    new_password1 = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={"class": "form-control", "placeholder": _("Новый пароль")}
        ),
    )
